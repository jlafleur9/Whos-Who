...
export class PlayComponent implements OnInit {
  ...
  artistList: { [key: string]: string[] } = {
    Pop: [
      "Taylor Swift", "Justin Bieber", "Ariana Grande", "Katy Perry", "Bruno Mars", 
      "Ed Sheeran", "Shawn Mendes", "Selena Gomez", "Dua Lipa", "Billie Eilish", 
      "Lady Gaga", "The Weeknd", "Adele", "Charlie Puth", "Halsey", 
      "Camila Cabello", "Beyoncé", "Rihanna", "Sam Smith", "Maroon 5", 
      "Harry Styles", "Olivia Rodrigo", "Ellie Goulding", "Shakira", "Miley Cyrus", 
      "Demi Lovato", "Sia", "Nicki Minaj", "Post Malone", "Lizzo", 
      "Alicia Keys", "Lana Del Rey", "Jason Derulo", "Meghan Trainor", "John Legend", 
      "Niall Horan", "Jonas Brothers", "Lil Nas X", "Khalid", "P!nk", 
      "Zayn", "Carly Rae Jepsen", "Tove Lo", "Ava Max", "Tinashe", 
      "Bebe Rexha", "Julia Michaels", "Troye Sivan", "Doja Cat", "Rita Ora"
    ],
    Country: [
      "Blake Shelton", "Luke Bryan", "Carrie Underwood", "Miranda Lambert", "Keith Urban", 
      "Dolly Parton", "Tim McGraw", "Shania Twain", "Kenny Chesney", "Garth Brooks", 
      "Chris Stapleton", "Kacey Musgraves", "Zac Brown Band", "Lady A", "Florida Georgia Line", 
      "Reba McEntire", "Jason Aldean", "Brad Paisley", "Dierks Bentley", "Sam Hunt", 
      "Morgan Wallen", "Luke Combs", "George Strait", "Alan Jackson", "Eric Church", 
      "Martina McBride", "Trisha Yearwood", "Rascal Flatts", "Thomas Rhett", "Maren Morris", 
      "Little Big Town", "Scotty McCreery", "Vince Gill", "LeAnn Rimes", "Hank Williams Jr.", 
      "Brantley Gilbert", "Billy Ray Cyrus", "Brooks & Dunn", "Clint Black", "Kane Brown", 
      "Dustin Lynch", "Brett Eldredge", "Kelsea Ballerini", "Jimmie Allen", "Cody Johnson", 
      "Trace Adkins", "Tyler Childers", "Patsy Cline", "Lauren Alaina", "Dan + Shay"
    ],
    HipHop: [
      "Kendrick Lamar", "Drake", "J. Cole", "Nicki Minaj", "Travis Scott", 
      "Cardi B", "Lil Wayne", "Kanye West", "Jay-Z", "Megan Thee Stallion", 
      "Future", "Post Malone", "Lil Baby", "21 Savage", "A$AP Rocky", 
      "Childish Gambino", "Doja Cat", "Nas", "Eminem", "Juice WRLD", 
      "Lil Uzi Vert", "DaBaby", "Young Thug", "Tyler, The Creator", "Roddy Ricch", 
      "Offset", "Quavo", "Migos", "Big Sean", "Tory Lanez", 
      "Lil Durk", "Playboi Carti", "YG", "2 Chainz", "Snoop Dogg", 
      "Run The Jewels", "Polo G", "Pop Smoke", "Machine Gun Kelly", "Lil Yachty", 
      "Logic", "Chance the Rapper", "Gucci Mane", "Rakim", "Rick Ross", 
      "Fetty Wap", "Pusha T", "Wiz Khalifa", "Mac Miller", "Trippie Redd"
    ],
    EDM: [
      "Calvin Harris", "David Guetta", "Marshmello", "Zedd", "The Chainsmokers", 
      "Diplo", "Kygo", "Martin Garrix", "Skrillex", "Deadmau5", 
      "Steve Aoki", "Avicii", "Alan Walker", "DJ Snake", "Tiesto", 
      "Armin van Buuren", "Oliver Heldens", "Hardwell", "Above & Beyond", "Kaskade", 
      "Afrojack", "Alesso", "Bassnectar", "Dillon Francis", "Madeon", 
      "Porter Robinson", "Nero", "Seven Lions", "Illenium", "Excision", 
      "RL Grime", "Flume", "Paul van Dyk", "Dash Berlin", "Eric Prydz", 
      "Don Diablo", "Nicky Romero", "Duke Dumont", "Deorro", "Louis The Child", 
      "Benny Benassi", "Tchami", "Shiba San", "Malaa", "Rezz", 
      "Gryffin", "Robin Schulz", "Yellow Claw", "Matoma", "NGHTMRE"
    ],
    Rock: [
      "Linkin Park",
      "Deftones",
